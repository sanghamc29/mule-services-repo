...
error: {
	...
	errorDescription: error.errorMessage.payload.errors default ( if(vars.errorDescription != null) vars.errorDescription else (error.description default "No desc provided."))
}